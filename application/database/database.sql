...
-- -----------------------------------------------------
-- Table `monumentzo`.`Monument_Image`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `monumentzo`.`Monument_Image` (
  `MonumentID` INT UNSIGNED NOT NULL ,
  `ImageID` INT UNSIGNED NOT NULL ,
  PRIMARY KEY (`MonumentID`, `ImageID`) ,
  INDEX `Monumentzo.Monument_Image.MonumentID` (`MonumentID` ASC) ,
  CONSTRAINT `Monumentzo.Monument_Image.MonumentID`
...
CREATE  TABLE IF NOT EXISTS `monumentzo`.`Monument` (
  ...
  CONSTRAINT `Monumentzo.Monument.ImageID`
    FOREIGN KEY (`ImageID` )
    REFERENCES `monumentzo`.`Monument_Image` (`ImageID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
