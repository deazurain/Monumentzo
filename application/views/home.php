...
<div class="hero-unit">
    ...
    <div class="well black">
        <p>
            Bekijk de mooiste monumenten en ontdek de blijde wereld van het culturele erfgoed van Nederland.</br>
            Gebruik de blader functie om op een interactieve wijze de monumenten van de lage landen te verkennen.</br>
